...
class MergeSplit_Isolated(TestCase):
    ...
    def setUp(s):
        ...
        s.feat0 = [ feature_circle(10, 15, 6, 0, 0),  # split 0
                    feature_circle(25, 12, 4, 1, 0) ] # isolated 0
        s.feat1 = [ feature_circle( 8, 19, 3, 2, 1),  # split 1
                    feature_circle(15, 16, 4, 3, 1),  # split 1
                    feature_circle(25, 17, 5, 4, 1) ] # isolated 1
    ...
    def test_merging_isolated(s):
        for f in s.feat1: f.timestep = 0
        for f in s.feat0: f.timestep = 1
...
class MergeSplit_Complex_Mixed(MergeSplit_Complex_Mixed_base):
    ...
    def setUp(s):
        ...
        if s.plot:
            ...
            plot_contours(outfile, features,
                    labels=lambda f:"{}".format(f.id()))
